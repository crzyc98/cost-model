...
def add_termination_target(df: pd.DataFrame, id_col: str, year_col: str, target: str) -> pd.DataFrame:
...
def calculate_features(df: pd.DataFrame, birth_col: str, hire_col: str, ref_col: str) -> pd.DataFrame:
    ref = df[ref_col]
    # vectorized age
    df['age'] = ref.dt.year - df[birth_col].dt.year - (
