...
def main():
    ...
    for scenario, data in scenarios.items():
        ...
        print(f'  Age change: {age_change:+.1f} years ({data[2025]["mean_age"]:.1f} → {data[2029]["mean_age"]:.1f})')
        print(f'  Employee change: {emp_change:+d} ({data[2025]["employees"]} → {data[2029]["employees"]})')
