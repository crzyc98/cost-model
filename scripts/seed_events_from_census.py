...
def seed_from_census(
    ...
    for col in EVENT_COLS:
        if col not in events.columns:
            # TODO: Define or import event_log.EVENT_PANDAS_DTYPES before use
            dtype = None  # event_log.EVENT_PANDAS_DTYPES.get(col)
...
if __name__ == "__main__":
    ...
    seed_from_census(input_path=Path(args.census), output_path=Path(args.out))
