...
def extract_key_parameters(config_path):
    ...
    try:
        ...
        params = {
            ...
            "annual_compensation_increase_rate": global_params.get(
                "annual_compensation_increase_rate"
            ),
            "target_growth": global_params.get("target_growth"),
            "termination_base_rate_for_new_hire": global_params.get("termination_hazard", {}).get(
                "base_rate_for_new_hire"
            ),
            # Promotion parameters
            "promotion_base_rate": global_params.get("promotion_hazard", {}).get("base_rate"),
            "promotion_level_dampener_factor": global_params.get("promotion_hazard", {}).get(
            ...
            "term_age_mult_60_65": global_params.get("termination_hazard", {})
            .get("age_multipliers", {})
            .get("60-65"),
            "term_age_mult_65_plus": global_params.get("termination_hazard", {})
            .get("age_multipliers", {})
            .get("65+"),
...
def main():
    ...
    print(
        f"   Configs with high annual_compensation_increase_rate (>=0.04): {len(high_comp_increase)}"
    )
