...
def check_integration():
    ...
    try:
        ...
        if gross_hires == 28 and forced_terms == 0:
            ...
            print(f"❌ Function returns unexpected values: expected (28, 0), got ({gross_hires}, {forced_terms})")
...
def check_old_vs_new_results():
    ...
    try:
        from cost_model.engines.run_one_year.utils import compute_headcount_targets, manage_headcount_to_exact_target
        ...
        print(f"Old method: Target={target_eoy_old}, Net={net_needed_old}, Gross={gross_needed_old}")
