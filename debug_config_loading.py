...
def test_config_loading():
    ...
    logger.info(f"Global parameters attributes: {[attr for attr in dir(gp) if not attr.startswith('_')]}")
    ...
    logger.info(f"Pydantic model new_hire_termination_rate: {main_config.global_parameters.new_hire_termination_rate}")
