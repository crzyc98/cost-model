...
def create_zero_growth_test_config() -> Path:
    ...
    config['global_parameters']['cola_hazard']['by_year'] = {
        2025: 0.00, 2026: 0.00, 2027: 0.00, 2028: 0.00, 2029: 0.00
    }
        ...
        if metrics_file.exists():
            ...
            if len(df) > 1:
                ...
                for _, row in df.iterrows():
                    ...
                    print(f"  {year}: {headcount:3d} employees, avg ${avg_comp:,.0f}, total ${total_comp}")
                        ...
                        for year_file in sorted(yearly_files):
                            ...
                            if not snapshot_df.empty:
                                ...
                                if not active_employees.empty:
                                    ...
                                    print(f"  {year}: {len(active_employees):3d} active, "
...
def analyze_pay_growth_components():
    ...
    if baseline_result and zero_result:
        ...
        if zero_result['pay_growth'] < 0:
            ...
            print(f"  Even with 0% ALL compensation increases, pay growth is {zero_result['pay_growth']:.2%}")
