...
class DummyIRS:
    ...
    def __init__(self, limits, year):
        self.model = type('M', (), {'year': year, 'scenario_config': {'irs_limits': limits}})
...
@pytest.mark.parametrize("tenure,expected_match", [
    (24, Decimal('45.00')),  # 20% deferral yields 120; tier1 60@50%=30 + tier2 60@25%=15 =>45
