...
def create_ultra_precision_config(
    ...
    term_mult = {
        "<1": 0.25, "1-3": 0.7, "3-5": 0.4, "5-10": 0.20, "10-15": 0.12, "15+": 0.24
    }
    age_mult = {
        "<30": 0.3, "30-39": 0.8, "40-49": 1.0, "50-59": 1.5, "60-65": 8.0, "65+": 12.0
    }
    promo_mult = {
        "<1": 0.5, "1-3": 1.5, "3-5": 2.0, "5-10": 1.0, "10-15": 0.3, "15+": 0.1
    }
    promo_age_mult = {
        "<30": 1.4, "30-39": 1.1, "40-49": 0.9, "50-59": 0.4, "60-65": 0.1
    }
...
def main():
    ...
    for i, params in enumerate(test_configs):
        target_growth, new_hire_rate, annual_comp_rate, term_base_rate, merit_base, cola_rates = params
        ...
        config_path = create_ultra_precision_config(
            target_growth, new_hire_rate, annual_comp_rate, 
            term_base_rate, merit_base, cola_rates
        )
