...
def create_fixed_precision_config(
    ...
    set_nested(config, "global_parameters.raises_hazard.merit_tenure_bump_value", 0.010)  # Higher bump
    set_nested(config, "global_parameters.raises_hazard.merit_low_level_bump_value", 0.010)  # Higher bump
...
def run_fixed_precision_campaign():
    ...
    for i, params in enumerate(fixed_configs):
        target_growth, new_hire_rate, annual_comp_rate, merit_base, cola_rates, promotion_raise, term_base_rate, new_hire_age, comp_boost = params
        ...
        config_path = create_fixed_precision_config(
            target_growth, new_hire_rate, annual_comp_rate, merit_base, 
            cola_rates, promotion_raise, term_base_rate, new_hire_age, comp_boost
        )
