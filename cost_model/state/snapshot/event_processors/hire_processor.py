...
from cost_model.state.schema import (
    EVT_HIRE, EMP_ID, EMP_HIRE_DATE, EMP_BIRTH_DATE, EMP_GROSS_COMP,
    EMP_ACTIVE, EMP_EXITED, SIMULATION_YEAR
)
...
class HireEventProcessor(BaseEventProcessor):
    ...
    def process_events(
        ...
        try:
            ...
            # Check integrity
            integrity_issues = self.ensure_snapshot_integrity(snapshot, updated_snapshot, hire_events)
