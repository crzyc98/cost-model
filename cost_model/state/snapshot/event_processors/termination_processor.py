...
from cost_model.state.schema import (
    EVT_TERM, EVT_NEW_HIRE_TERM, EMP_ID, EMP_TERM_DATE, EMP_ACTIVE, EMP_EXITED
)
...
class TerminationEventProcessor(BaseEventProcessor):
    ...
    def process_events(
        ...
        try:
            ...
            # Check integrity
            integrity_issues = self.ensure_snapshot_integrity(snapshot, updated_snapshot, term_events)
