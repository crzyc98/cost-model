...
from cost_model.state.schema import EVT_CONTRIB, EMP_ID, EMP_CONTR, EMPLOYER_CORE, EMPLOYER_MATCH
        ...
        try:
            ...
            for _, contrib_event in contrib_events.iterrows():
                ...
                if not contribution_data:
                    result.add_warning(f"Could not extract contribution values for employee {emp_id}")
                    continue
