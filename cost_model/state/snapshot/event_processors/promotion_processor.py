...
from cost_model.state.schema import EVT_PROMOTION, EMP_ID, EMP_LEVEL, EMP_LEVEL_SOURCE
                ...
                if EMP_ID in updated_snapshot.columns:
                    ...
                    if employee_mask.any():
                        ...
                        if EMP_LEVEL_SOURCE in updated_snapshot.columns:
                            updated_snapshot.loc[employee_mask, EMP_LEVEL_SOURCE] = 'promotion_event'
