...
class SnapshotDTypes:
    ...
    CATEGORICAL_VALUES: Dict[str, list] = {
        ...
        SnapshotColumns.EMP_LEVEL_SOURCE: [
            "PROVIDED",
            "INFERRED_FROM_COMPENSATION",
            "DEFAULT",
            "NO_COMPENSATION_DATA",
        ],
    }
...
class EventDTypes:
    ...
    CATEGORICAL_VALUES: Dict[str, list] = {
        ...
        EventColumns.CREATED_BY: ["system", "user", "import", "simulation", "auto_rule"],
    }
...
class DataTypeValidator:
    ...
    def validate_snapshot_dtypes(df: pd.DataFrame) -> Dict[str, Any]:
        ...
        """
        results = {"valid": True, "errors": [], "warnings": [], "conversions_needed": {}}
    ...
    @staticmethod
    def convert_snapshot_dtypes(df: pd.DataFrame, strict: bool = False) -> pd.DataFrame:
                ...
                if target_dtype == "category":
                    ...
                    if categories:
                        df_converted[column] = pd.Categorical(
                            df_converted[column], categories=categories
                        )
                    else:
