...
def apply_eligibility(
    df: DataFrame, scenario_config: Dict[str, Any], simulation_year_end: pd.Timestamp
) -> DataFrame:
    """
...
def apply_auto_increase(
    df: DataFrame, plan_rules: Dict[str, Any], simulation_year: int
) -> DataFrame:
...
def calculate_contributions(
    df: DataFrame, scenario_config: Dict[str, Any], simulation_year: int
) -> DataFrame:
    """
