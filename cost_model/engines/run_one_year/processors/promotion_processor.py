...
from cost_model.state.schema import EMP_ID, SIMULATION_YEAR, EMP_LEVEL, EMP_TENURE_BAND, EMP_ACTIVE
...
class PromotionProcessor(BaseProcessor):
    ...
    def process(
        ...
        **kwargs
        ...
        try:
            ...
            self.logger.info(f"Processing promotions for {len(experienced_employees)} experienced employees")
    ...
    def validate_inputs(self, snapshot: pd.DataFrame, year: int, 
