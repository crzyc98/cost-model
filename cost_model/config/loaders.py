...
def load_yaml_config(config_path: Path) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        if not isinstance(config_data, dict):
             ...
             raise ConfigLoadError(f"Invalid configuration format in {config_path}: Expected a dictionary.")
...
if __name__ == '__main__':
    ...
    try:
        ...
        example_config_path = Path(__file__).parent.parent.parent / 'configs' / 'dev_tiny.yaml'
