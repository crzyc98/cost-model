...
def progress_context(logger: SnapshotLogger, operation: str, total_items: Optional[int] = None):
    ...
    logger.info(f"Starting {operation}", total_items=total_items, start_memory_mb=start_memory)
...
class PerformanceMonitor:
    ...
    def add_checkpoint(self, name: str, **additional_metrics):
        ...
        self.logger.debug(f"Checkpoint {name} for {self.operation}", **checkpoint_metrics)
